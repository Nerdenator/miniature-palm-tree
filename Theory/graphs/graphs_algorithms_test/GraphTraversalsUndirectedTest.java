...
public class GraphTraversalsUndirectedTest {

	int numVert = 8;
	int capacity = 10;

	UndirectedUnweightedGraphM<Integer> GM;

	UndirectedUnweightedGraphL<Integer> GL;

	String DFS1 = "[ 0 1 4 7 2 5 3 6 ]";
	String BFS1 = "[ 0 1 2 3 4 5 6 7 ]";

	String DFS2 = "[ 0 1 2 4 3 5 6 7 ]";
	String BFS2 = "[ 0 1 2 4 6 3 5 7 ]";
	...
	public void setUp() {
		...
		GM = new UndirectedUnweightedGraphM<Integer>(capacity, vertices);

		// Graph represented using adjacency list
		GL = new UndirectedUnweightedGraphL<Integer>(capacity, vertices);
	}
