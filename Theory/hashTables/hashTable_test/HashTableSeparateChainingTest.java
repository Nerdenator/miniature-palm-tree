...
import hashTable_src.HashTableSeparateChaining;
...
public class HashTableSeparateChainingTest {
	...
	public void setUp() throws Exception {
		...
		numEntriesStr = 3;
		tableStr.insert("ab"); // (a*31 + b + 7) % 5 = (97*31^2 + 98*31 + 7) % 5
								// = 96262 % 5 = 2
		tableStr.insert("abc"); // (97*31^3 + 98*31^2 + 99*31 + 7) % 5 = 2986981
								// % 5 = 1
		tableStr.insert("abcd"); // (97*31^4 + 98*31^3 + 99*31^2 + 100*31 + 7) %
									// 5 = 92599301 % 5 = 1
	...
	public void testSetUp() {
		Assert.assertEquals("{0: [20, 10]}, {1: []}, {2: [87]}, {3: [18]}, {4: []}", tableInt.toString());
		Assert.assertEquals("{0: []}, {1: [abcd, abc]}, {2: [ab]}, {3: []}, {4: []}", tableStr.toString());
		Assert.assertEquals("{0: []}, {1: []}, {2: [a]}, {3: [5]}, {4: [c, 1]}", tableChr.toString());
	}
	...
	public void testInsertInteger() throws Exception {
		...
		Assert.assertEquals("{0: [20, 10]}, {1: []}, {2: [87]}, {3: []}, {4: []}", table.toString());

		table.insert(18); // 18 % 5 = 3
		table.insert(61); // 61 % 5 = 1
		table.insert(22); // 22 % 5 = 2
		table.insert(44); // 44 % 5 = 4
		Assert.assertEquals("{0: [20, 10]}, {1: [61]}, {2: [22, 87]}, {3: [18]}, {4: [44]}", table.toString());

		table.insert(53); // 53 % 5 = 3
		table.insert(8); /// 8 % 5 = 3
		Assert.assertEquals("{0: [20, 10]}, {1: [61]}, {2: [22, 87]}, {3: [8, 53, 18]}, {4: [44]}", table.toString());
	}
	...
	public void testInsertString() throws Exception {
		...
		table.insert("ab"); // (a*31 + b + 7) % 5 = (97*31^2 + 98*31 + 7) % 5 =
							// 96262 % 5 = 2
		table.insert("abc"); // (97*31^3 + 98*31^2 + 99*31 + 7) % 5 = 2986981 %
								// 5 = 1
		table.insert("abcd"); // (97*31^4 + 98*31^3 + 99*31^2 + 100*31 + 7) % 5
								// = 92599301 % 5 = 1
		Assert.assertEquals("{0: []}, {1: [abcd, abc]}, {2: [ab]}, {3: []}, {4: []}", table.toString());
	}
	...
	public void testInsertCharacter() throws Exception {
		...
		Assert.assertEquals("{0: []}, {1: []}, {2: [a]}, {3: [5]}, {4: [c, 1]}", table.toString());

		table.insert('4'); // '4' = 52; 52 % 5 = 2
		table.insert('e'); // 'e' = 101; 101 % 5 = 1
		table.insert('7'); // '7' = 55; 55 % 5 = 0
		table.insert('f'); // 'f' = 102; 102 % 5 = 2
		Assert.assertEquals("{0: [7]}, {1: [e]}, {2: [f, 4, a]}, {3: [5]}, {4: [c, 1]}", table.toString());
	}
