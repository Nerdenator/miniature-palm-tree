 ...
 *
 */
public class LstUndirectedUnweightedGraph<MyType> implements InterfaceUnweightedGraph<MyType> {
	...
	public LstUndirectedUnweightedGraph(int capacity, Vertex<MyType>[] vertices) {
