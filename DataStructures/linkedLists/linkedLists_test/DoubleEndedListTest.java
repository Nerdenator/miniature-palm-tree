...
import linkedLists_src.DoubleEndedList;
import linkedLists_util.Node;

public class DoubleEndedListTest {
	DoubleEndedList<Integer> list;
	DoubleEndedList<Integer> empty;
	DoubleEndedList<Integer> one;

	@Before
	public void setUp() {
		empty = new DoubleEndedList<>();
		one = new DoubleEndedList<>(10);
		list = new DoubleEndedList<>(new Integer[] { 1, 2, 4, 7, 2, 3 });
	}
