package arrayLists_test;

import org.junit.Assert;
import org.junit.Before;
import org.junit.Test;

import arrayLists_src.DynamicArray;
...
public class DynamicArrayTest {
	...
	public void testSet() throws Exception{
		Assert.assertEquals("[0 1 2 3 4 5 6 7]", dArr2.print());
		dArr2.set(2, 20);
		Assert.assertEquals("[0 1 20 3 4 5 6 7]", dArr2.print());
	}
	...
	public void testDelete(){
		Assert.assertEquals("[0 1]", dArr3.print());
		Assert.assertEquals(1,dArr3.getLastIndex());
		dArr3.delete();
		Assert.assertEquals("[0]", dArr3.print());
		Assert.assertEquals(0,dArr3.getLastIndex());
		dArr3.delete();
		Assert.assertEquals("[]", dArr3.print());
		Assert.assertEquals(-1,dArr3.getLastIndex());
		dArr3.delete();
		Assert.assertEquals("[]", dArr3.print());
		Assert.assertEquals(-1,dArr3.getLastIndex());
	...
	public void testInsertAt(){
		...
		Assert.assertEquals("[0 1]", dArr3.print());
		dArr3.insertAt(0, -1);
		Assert.assertEquals("[-1 0 1]", dArr3.print());
		Assert.assertEquals(4, dArr3.getArraySize());
		Assert.assertEquals(2, dArr3.getLastIndex());
		dArr3.insertAt(1, 20);
		Assert.assertEquals("[-1 20 0 1]", dArr3.print());
		Assert.assertEquals(4, dArr3.getArraySize());
		Assert.assertEquals(3, dArr3.getLastIndex());
		dArr3.insertAt(3, 40);
		Assert.assertEquals("[-1 20 0 40 1]", dArr3.print());
	...
	public void testDeleteAt(){
		...
		dArr2.deleteAt(2);
		Assert.assertEquals("[0 1 3 4 5 6 7]", dArr2.print());
		Assert.assertEquals(6,dArr2.getLastIndex());
		dArr2.deleteAt(6);
		Assert.assertEquals("[0 1 3 4 5 6]", dArr2.print());
		Assert.assertEquals(5,dArr2.getLastIndex());
		dArr2.deleteAt(0);
		Assert.assertEquals("[1 3 4 5 6]", dArr2.print());
		Assert.assertEquals(4,dArr2.getLastIndex());
		dArr2.deleteAt(2);
		Assert.assertEquals("[1 3 5 6]", dArr2.print());
		Assert.assertEquals(3,dArr2.getLastIndex());
		dArr2.deleteAt(2);
		Assert.assertEquals("[1 3 6]", dArr2.print());
		Assert.assertEquals(2,dArr2.getLastIndex());
		dArr2.deleteAt(1);
		Assert.assertEquals("[1 6]", dArr2.print());
		Assert.assertEquals(1,dArr2.getLastIndex());
		dArr2.deleteAt(1);
		Assert.assertEquals("[1]", dArr2.print());
		Assert.assertEquals(0,dArr2.getLastIndex());
		dArr2.deleteAt(0);
		Assert.assertEquals("[]", dArr2.print());
		Assert.assertEquals(-1,dArr2.getLastIndex());
	}
