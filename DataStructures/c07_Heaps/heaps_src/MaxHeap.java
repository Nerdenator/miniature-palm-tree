...
public class MaxHeap {
	...
	public void insert(int val) {
		...
		// then move it up to its correct position in which the heap property is
		// satisfied
	 ...
	 * @param A
	 */
	public void bubbleUp_Iterative(int pos, int[] A) {
	...
	public int delete() {
		...
		// the node at the root is too small for that position, so it's moved
	 ...
	 * @param A
	 */
	public void bubbleDown_Iterative(int pos, int[] A) {//
		...
		while (pos < A.length) {
			...
			// if there is only a left child
				...
				maxIdx = leftIdx;
			// otherwise, there's both a left and right child, find position of
			// max
	 ...
	 * @param pos
	 */
	public void bubbleDown_Recursive(int pos, int[] A) {
		int leftIdx = getLeftChildIndex(pos);
		int rightIdx = getRightChildIndex(pos);
		int maxIdx = 0;
